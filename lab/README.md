...
+ the server-only refusal) run as incremental real-agent sessions against the recorded
package — the fixture is regenerated by continuation, not from scratch.
