...
and artifacts) lives in [`skill/references/workflow.md`](skill/references/workflow.md). This document
summarizes and links — it does not re-paste the operational spec.

> See also: [`METHODOLOGY.md`](METHODOLOGY.md) (rationale), [`ARTIFACT-CATALOG.md`](ARTIFACT-CATALOG.md)
> (what each stage produces), [`skill/references/quality-gates.md`](skill/references/quality-gates.md) (gate
> definitions), and [`skill/references/governance.md`](skill/references/governance.md) (statuses and IDs).
...
the workflow runs, never the methodology. See [`skill/references/modes.md`](skill/references/modes.md).
...
identifiers, versioning, and supersession rules: [`skill/references/governance.md`](skill/references/governance.md).
...
[`skill/references/quality-gates.md`](skill/references/quality-gates.md).
...
Fail · Human · Artifacts) is in [`skill/references/workflow.md`](skill/references/workflow.md)** — this table
does not replace it. Gate IDs reference [`skill/references/quality-gates.md`](skill/references/quality-gates.md);
...
read [`skill/references/workflow.md`](skill/references/workflow.md). For which artifacts a stage may emit and
their generation classes, read [`ARTIFACT-CATALOG.md`](ARTIFACT-CATALOG.md). For the gate definitions and
severities, read [`skill/references/quality-gates.md`](skill/references/quality-gates.md).
