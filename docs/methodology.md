...
and recorded *before* their mutations. The one removal a caller can make is a wrongly typed
...
(v4.6) (safeguard 16). Operational detail: `../plugins/tamheed/db/CANONICAL.md`.
