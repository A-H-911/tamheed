...
name: phase-close
description: >-
  Invoke to close a phase deliberately: the phase-scope readiness failures resolved or waived on the operator's words, expired waivers, milestones, human gates, then the guarded Implemented transition.
...
Invoke this (`/tamheed:phase-close`) to close a phase of `<package>` (semi-auto; distinct from slice-review —
