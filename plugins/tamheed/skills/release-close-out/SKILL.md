...
description: >-
  Invoke to close out a release at package scope, blocking-clean: every blocking readiness failure resolved, expired waivers renewed on the operator's words, human gates decided, release notes, bindings.
...
Invoke this (`/tamheed:release-close-out`) to close out a release of `<package>` (semi-auto: forced transitions and
