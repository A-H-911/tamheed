...
name: progress-sync
description: >-
  Invoke after implementation work to bring the package up to date: typed progress entries, Review claims, bindings, evidenced verdicts, scope changes first, lessons, trace edges.
...
Invoke this (`/tamheed:progress-sync`) after implementation work on `<package>` to bring the package up to date.
