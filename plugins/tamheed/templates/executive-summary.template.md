...
<!-- The whole story compressed: problem, chosen approach, headline outcome. -->
<elevator-paragraph>

## Problem and objective

<!-- 2-3 sentences. Mirror the charter, do not re-derive it. -->
<problem-and-objective>
...
| | Summary |
|---|---|
| MVP delivers | <one line> |
| Full target adds | <one line> |
| Explicitly out of scope | <one line> |
...
<!-- The 3-5 that matter; reference the register. -->
- `RISK-001` <one line + how it's handled>.
- `RISK-002` <one line + how it's handled>.

## What we are asking for

<!-- The decision or approval this summary requests. -->
