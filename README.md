...
<p align="center">
  <em>Claude Code plugin + MCP-backed agent skill &middot; v5.1.0</em> &middot;
...
**v5.x** (currently v5.1.0). The methodology (22 stages), the re-baselined relational store (plan 031:
