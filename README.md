...
<p align="center">
  <em>Claude Code plugin + MCP-backed agent skill &middot; v4.11.0</em> &middot;
...
**v4.x** (currently v4.11.0). The methodology (22 stages), the re-baselined relational store (plan 031:
