...
| Handoff to an execution agent | **Repo bootstrap + follow-up/review prompts + DoR/DoD** (`scripts/`, `handoff/`, `execution/definition-of-ready.md`, `execution/definition-of-done.md`) | The package is executed by another agent; it needs an init script, staged prompts, and explicit ready/done gates. |
